 ...
 * ```
 */
export function getTextColorClass(name: string): string {
  const colorName = getColorName(name)
 ...
 * ```
 */
export function getBgColorClass(name: string, opacity: number = 15): string {
  const colorName = getColorName(name)
 ...
 * ```
 */
export function getBorderColorClass(name: string, opacity: number = 25): string {
  const colorName = getColorName(name)
 ...
 * ```
 */
export function getCategoryColorStyle(name: string): React.CSSProperties {
  const colorName = getColorName(name)
  return {
